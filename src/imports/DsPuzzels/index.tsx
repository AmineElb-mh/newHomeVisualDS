import svgPaths from "./svg-vahgzctx8l";
...
export default function DsPuzzels() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] items-center pt-[173px] relative size-full" data-name="DS Puzzels">
      <Group />
      <div className="absolute bottom-0 h-[698px] left-[calc(50%-188px)] pointer-events-none top-[102px]">
