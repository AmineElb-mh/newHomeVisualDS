...
const SLIDES: VideoSlideData[] = [
  {
    src: "/videos/tupac.mp4",
    category: "Video",
    title: "Bijna dertig jaar na de moord op Tupac Shakur heeft een jury Duane ‘Keffe D’ Davis schuldig bevonden.",
    topicsCount: 3,
  },
  {
    src: "/videos/video1.mp4",
    category: "Video",
    title: "'Caroline Schouten na abseiltocht Euromast",
    topicsCount: 3,
  },
];

const PILL_TABS = ["Vandaag", "Sport", "Politiek", "Cultuur"];
