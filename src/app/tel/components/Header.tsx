import imgLogo from "../assets/logo-main-inverse.svg";
...
function AccountActions() {
  return (
    <div className="content-stretch flex gap-[var(--scale-5)] items-center relative shrink-0">
      <div className="[word-break:break-word] flex flex-col font-[family-name:var(--font-family-secondary)] font-bold justify-center leading-[0] relative shrink-0 text-[length:var(--font-size-md)] text-white whitespace-nowrap">
        <p className="leading-[1.1]">Subscribe</p>
      </div>
...
export default function Header() {
  return (
    <div className="bg-[color:var(--color-primary-60)] relative shrink-0 w-full" data-name="Header">
      <StatusBar dark />
      <div className="content-stretch flex h-[48px] items-center justify-between px-[var(--scale-7)] py-[var(--scale-6)] w-full" data-name="header-nav">
        <img alt="De Telegraaf" className="h-[24px] w-auto object-contain" src={imgLogo} />
        <AccountActions />
      </div>
    </div>
  );
